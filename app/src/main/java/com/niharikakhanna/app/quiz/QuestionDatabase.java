...
public class QuestionDatabase extends Application {
    ...
    public static Questions[] getArray() {
         mQuestionBank = new Questions[]{
                new Questions(R.drawable.ic_pizzahut, "Pizza Hut", arrayOne, false, false),
                new Questions(R.drawable.ic_amazon, "Amazon", arrayTwo, false, false),
                new Questions(R.drawable.ic_bmw, "BMW", arrayThree, false, false),
                new Questions(R.drawable.ic_barbie, "Barbie", arrayFour, false, false),
                new Questions(R.drawable.ic_burgerking, "Burger King", arrayFive, false, false),
                new Questions(R.drawable.ic_citroen, "Citroen", arraySix, false, false),
                new Questions(R.drawable.ic_starbucks, "Starbucks", arraySeven, false, false),
                new Questions(R.drawable.ic_twitter, "Twitter", arrayEight, false, false),
                new Questions(R.drawable.ic_hp, "HP", arrayNine, false, false),
                new Questions(R.drawable.ic_ibm, "IBM", arrayTen, false, false),
                new Questions(R.drawable.ic_redbull, "Red Bull", arrayEleven, false, false),
                new Questions(R.drawable.ic_loreal, "L'Oréal", array12, false, false),
                new Questions(R.drawable.ic_louisvuitton, "Louis Vuitton", array13, false, false),
                new Questions(R.drawable.ic_mcdonalds, "McDonald's", array14, false, false),
                new Questions(R.drawable.ic_michelin, "Michelin", array15, false, false),
                new Questions(R.drawable.ic_mtv, "MTV", array16, false, false),
                new Questions(R.drawable.ic_skype, "Skype", array17, false, false),
                new Questions(R.drawable.ic_volkswagen, "Volkswagen", array18, false, false),
                new Questions(R.drawable.ic_pringles, "Pringles", array19, false, false),
                new Questions(R.drawable.ic_reebok, "Reebok", array20, false, false),
                new Questions(R.drawable.ic_quiksilver, "Quiksilver", array21, false, false),
                new Questions(R.drawable.ic_nike, "Nike", array22, false, false),
                new Questions(R.drawable.ic_nissan, "Nissan", array23, false, false),
        };
